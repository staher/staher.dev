...
- 2024-11-24: Styling → Tailwind v4 with DaisyUI for built-in themes/components (dark default, toggle to light); tradeoff is adopting DaisyUI’s design layer and dependency.
## Update hook
